...
import useRequestContext from 'components/Request';
...
function SingUp() {
    ...
    const singUp = useContext(useRequestContext).singUp;
    ...
    const handleSubmit = (event) => {
        ...
        singUp(userName, userDoc, userBirthDate, userEmail, userLogin, userPassword, userType, userBalance);
      };

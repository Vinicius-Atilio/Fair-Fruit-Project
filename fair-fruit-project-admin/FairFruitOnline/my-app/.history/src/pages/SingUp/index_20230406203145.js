...
import Img from '/feira/fair-fruit-project-admin/FairFruitOnline/my-app/src/pages/IMG';
...
function User() {
    ...
    return (
        <>
            <Img/>
            <Image src="src/assets/teste.jpg" alt="Meuovo Logo"/>
            <img src="src/assets/teste.jpg" alt="Meuovo Logo"/>
            <Container>
                <Form>
                    <LockIcon />
                </Form>

          ...
          <FormLoginContainer>
            ...
            <StyledForm onSubmit={handleSubmit(onSubmit)}>
                ...
                <TextField
                  ...
                  helperText={errors ? errors.outlinedLogin?.message : null}
                  onBlur={() => {
                    if (errors.outlinedLogin){
                    clearErrors('outlinedLogin');
                    }
                  }}
                ...
                <TextField
                  ...
                  onBlur={() => {
                    if (errors.outlinedPassword){
                      clearErrors('outlinedPassword');
                    }
                  }}

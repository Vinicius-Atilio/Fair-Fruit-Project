        ...
        <form onSubmit={handleSubmit}>
          <div>
            <TextField
              ...
              sx={{ m: 1}}
              InputProps={{
                startAdornment: <InputAdornment position="start" type="text" value={productName} onChange={handleNameChange} required></InputAdornment>,
              }}
              variant="filled"
          />
          </div>
          ...
          <TextField
              ...
              sx={{ m: 1}}
              InputProps={{
                startAdornment: <InputAdornment position="start" value={productPrice} onChange={handlePriceChange} required step="0.01"></InputAdornment>,
              }}
              variant="filled"
          />
          </div>
